...
class Gejala extends CI_Controller
{
    ...
    {
        //$data['pertanyaan'] = $this->model_pertanyaan->getAll();
        $config['base_url'] = 'http://localhost/siskar_buahnaga/gejala/index';
        $config['total_rows'] = $this->model_pertanyaan->hitung_jumlah_pertanyaan();
        $config['per_page'] = '1';

        $this->pagination->initialize($config);

        $data['pertanyaan'] = $this->model_pertanyaan->getPertanyaan(4, 5);
    ...
    public function pertanyaan()
    {
        ...
        $config['base_url'] = 'http://localhost/siskar_buahnaga/gejala/pertanyaan';
        $config['total_rows'] = $this->model_pertanyaan->hitung_jumlah_pertanyaan();
        $config['per_page'] = '1';
